<div class="container">
<form action="admin/controller.php?action=add" class="form-horizontal well span9" method="post">
    <fieldset >
		<legend> SELF REGISTRATION FORM </legend>
		...
		<div class="form-group" id="idno">
			...
			<div class="col-md-8">
				...
				<div class="col-md-8">
					<input class="form-control input-sm" id="username" name="username" placeholder="User Name" type="text" value="">
				</div>
			</div> <br /><br /> 
			...
			<div class="col-md-8">
					...
					<div class="col-md-8">
						<select class="form-control input-sm" name="gender" id="gender"  placeholder="Gender">
							<option value=""></option>
			...
			<div class="col-md-8">
				...
				<div class="col-md-8">
					<input class="form-control input-sm" id="department" name="department" placeholder="Department" type="text" value="">
				</div>
			</div> <br /><br /> 
			...
			<div class="col-md-8">
				<label class="col-md-4 control-label" for="title">Title / User Type :</label>
				<div class="col-md-8">
			...
			<div class="col-md-8">
				...
				<div class="col-md-8">
					<input class="form-control input-sm" id="region" name="region" placeholder="Region" type="text" value="">
						...
						<div class="col-md-8">
				<label class="col-md-4 control-label" for="addreess">Address :</label>
				<div class="col-md-8">
					<input class="form-control input-sm" id="addreess" name="addreess" placeholder="Address" type="text" value="">
				</div>
			</div> <br /><br />

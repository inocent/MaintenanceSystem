...
<ul class="nav nav-tabs">
	<br>
	<li class="active"><a data-toggle="tab" href="#home"><strong>Furnitures</strong></a></li>
	<li><a data-toggle="tab" href="#new"><strong>Add New furniture</strong></a></li>
...
<div class="tab-content">	
	<div id="new" class="tab-pane fade">
		...
		<form name="form2" method="post" action="forms/furniture/controller.php?action=add">
			<fieldset>
			<br>
			...
			<table class="table table-striped" cellspacing="0">
				...
				<tbody>
					<?php
						...
						$furnitureList = $furniture->listOffurniture();
						$number=1;
						foreach ($furnitureList as $list) {
							echo '<td width="3%" >'; echo $number; echo '</td>';
							echo '<td width="3%"><input type="checkbox" name="selector[]" id="selector[]" value="'.$list->furniture_id.'"/>';
							echo '<td width="14%" >'. $list->name.'</td>';
							echo '<td width="15%" >'. $list->furniture_type.'</td>';
		...
		<form class="form-horizontal well span4" action="controller.php?action=add" method="POST">
			<fieldset>
				...
				<div class="form-group">
					<div class="rows">
						<div class="col-md-8">
							<label class="col-md-4 control-label" for="clientName">Total furnitures:</label>
							<div class="col-md-8">
								<?php 
			...
			<div class="panel panel-primary">
				<form class="form-horizontal well span4" action="controller.php?action=add" method="POST">
					<form class="form-horizontal well span4" action="#.php" method="POST">
						<fieldset>
							<legend>furniture Descriptions</legend>
							<div class="form-group">
								<div class="col-md-8">
									<label class="col-md-4 control-label" for="furniture_id">furniture Id</label>
									<div class="col-md-8">
										<input name="deptid" type="hidden" value="">
										<input class="form-control input-sm" id="furniture_id" name="furniture_id" placeholder="furniture Id" type="text" value="">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-md-8">
									<label class="col-md-4 control-label" for="name">furniture Name</label>
									<div class="col-md-8">
										<input name="deptid" type="hidden" value="">
										<input class="form-control input-sm" id="name" name="name" placeholder="furniture Name" type="text" value="">
									</div>
								</div>
							</div>
							<div class="form-group">
